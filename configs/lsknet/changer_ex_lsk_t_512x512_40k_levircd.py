...
data_root = '/home/share/remote_sense/LEVIR_CD/'
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/home/u1120230285/lyx/data/pretrained/lsk_t_backbone.pth.tar',
            type='Pretrained'),
...
work_dir = './work_dirs/changer_ex_lsk_t_512x512_40k_levircd'
